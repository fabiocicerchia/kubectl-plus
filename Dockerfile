...
# They track alpine:3.22; bump alongside the base image when dependabot updates it.
...
RUN apk add --no-cache bash=5.2.37-r0 curl=8.14.1-r3 jq=1.8.1-r0 gettext=0.24.1-r0 ca-certificates=20260611-r0 \
